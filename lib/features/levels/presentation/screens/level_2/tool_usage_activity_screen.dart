...
class _ToolUsageActivityScreenState extends State<ToolUsageActivityScreen> {
  ...
  void _onDropComplete() {
    ...
    FeedbackDialogs.showSuccess(
      context: context,
      title: 'أحسنت! 🌟',
      message: 'لقد اخترت الأداة الصحيحة!',
      buttonText: 'التالي',
      onPressed: () {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('اسحب الأداة الصحيحة', style: _cairo(fontSize: 22, fontWeight: FontWeight.bold, color: const Color(0xFF0F172A))),
                      const SizedBox(height: 4),
                      Text('ضع الأداة المناسبة في مكانها الصحيح', style: _cairo(fontSize: 15, color: const Color(0xFF64748B))),
                      const SizedBox(height: 24),
